...
const FandQSection = () => {
  ...
  return (
    <div className="container">
          ...
          <img src={star} alt="" />
          <h1 className="mb-3 mt-3 ms-2 me-2 font-700">Frequently Asked Questions</h1>
          <img src={star} alt="" />
        </div>
        ...
        <div>
          <div>
            ...
            <div className="accordion-section">
              ...
              >
                <div className="primary-color fw-bold">Does BHAU777 have License ?</div>
                <div className="collapese-icon">
                  <i
                    className={`fa ${
              ...
              {isOpen.license && (
                <div className="description-text">
                  <br />
                  Yes, BHAU777 Have Sub License In Malta. All Rights That
            ...
            <div className="accordion-section">
              ...
              {isOpen.depositWithdrawal && (
                <div className="description-text">
                  <br />
                  In BHAU777, We Allow Minimum of 100.00 Rs/- Deposit and
